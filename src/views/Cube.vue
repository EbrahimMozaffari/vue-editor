      ...
      <div class="actualCubeContainer">
        <div class="cubeFaces">
          ...
          <div class="cubeFace cubeFaceBack">
            <img
              class="pythonLogo"
              src="https://assets.algoexpert.io/g1ec323b14b-prod/dist/images/pythonLogo.png?d36eea0d"
              loading="lazy"
              alt="python logo"
            />
          </div>
          <div class="cubeFace cubeFaceTop">&nbsp;</div>
          <div class="cubeFace cubeFaceBottom">&nbsp;</div>
          <div class="cubeFace cubeFaceLeft">
            <img
              class="goLogo"
              src="https://assets.algoexpert.io/g1ec323b14b-prod/dist/images/goLogo.png?ddcc76d9"
              loading="lazy"
              alt="golang logo"
            />
          </div>
          <div class="cubeFace cubeFaceRight">
            <img
              class="cppLogo"
              src="https://assets.algoexpert.io/g1ec323b14b-prod/dist/images/cppLogo.png?f2d6c3f7"
              loading="lazy"
              alt="c++ logo"
            />
          </div>
...
.cubeFaceBack {
    transform: translateZ(-150px) rotateY(
180deg
);
    background-color: #3e526a;
}
